...
if __name__ == "__main__":
    ...
    # downsample each of them with approprate aggregrator
    dpos_ds, _ = fixed_freq_subsampler_for_pos(dpos, aggregate=True)
    dquat_ds, _ = fixed_freq_subsampler_for_quaternion(dquat, aggregate=True)
